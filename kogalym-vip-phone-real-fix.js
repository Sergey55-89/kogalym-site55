...
(function(){
  ...
  function cardTitle(card){
    return norm(card.querySelector('h3,h2,.ad-title,.ann-title,.ann-name,.ann-title,.card-title,.title')?.textContent || card.textContent.slice(0,80));
  }
  ...
  function findList(){
    return (
      document.querySelector('#annList') || document.querySelector('#adsList') ||
      document.querySelector('#announcementsList') ||
      document.querySelector('#announcements-list') ||
      document.querySelector('#cardsList') ||
      document.querySelector('.ann-list') || document.querySelector('.ads-list') ||
      document.querySelector('.announcements-list') ||
  ...
  function findCards(scope){
    ...
    let cards = Array.from(root.querySelectorAll('.ann-item,.ad-card,.announcement-card,.ann-card,.listing-card,.card'));
